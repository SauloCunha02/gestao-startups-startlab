...
Há três percursos, e a escolha é sua. A trilha completa, de 12 etapas, é a que sustenta a avaliação de 10 pontos. A Trilha Rápida, de sete passos em cerca de seis aulas, serve a turmas com carga reduzida, recuperação de percurso, feiras e revisão antes da apresentação. A Trilha Extrema é um sprint cronometrado de 50 minutos, em quatro blocos, que cabe em uma aula: a equipe monta uma startup inteira — para quem ela é, o nome, a proposta, como ganha dinheiro, a prova com duas pessoas e um pitch de dois minutos, com teto de três. O relógio avança de bloco em bloco sozinho e a ficha da startup se monta na tela enquanto os alunos escrevem. O exemplo dessa trilha é o caso real da Nubank, usado como referência de raciocínio: a página avisa que os valores da conta são simplificados, não são os da empresa, e que o tamanho dela não é a meta.
Use a Trilha Extrema para abrir o módulo mostrando uma startup nascer inteira, para uma oficina avulsa, para destravar uma equipe parada ou como aquecimento. Ela não substitui a investigação avaliada: duas conversas e dois testes em uma aula produzem a primeira versão de uma startup, não um negócio comprovado — os valores da conta do mês são hipóteses da equipe e o teste mede compreensão, não demanda. A própria página avisa isso ao aluno, reserva um campo obrigatório para o que a equipe ainda não sabe, e repete o aviso na ficha exportada. Se receber um sprint como entrega de nota, peça a investigação completa antes de pontuar.'''),
