...
Há três percursos, e a escolha é sua. A trilha completa, de 12 etapas, é a que sustenta a avaliação de 10 pontos. A Trilha Rápida, de sete passos em cerca de seis aulas, serve a turmas com carga reduzida, recuperação de percurso, feiras e revisão antes da apresentação. A Trilha Extrema é um sprint cronometrado de 50 minutos, em quatro blocos, que cabe em uma aula: a equipe monta uma startup inteira — para quem ela é, o nome, a proposta, como ganha dinheiro, a prova com duas pessoas e o pitch de um minuto. O relógio avança de bloco em bloco sozinho e a ficha da startup se monta na tela enquanto os alunos escrevem.
